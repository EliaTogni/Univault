Una **Simulation** (**Simulazione**) è il prodotto della modellazione a computer di un evento, un processo real-world o un sistema complesso, soprattutto al fine di studio.<br />
