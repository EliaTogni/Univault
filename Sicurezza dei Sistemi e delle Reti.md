...
Da sottolineare anche l'esistente possibilità di dichiarare di essere in grado di risolvere determinate zone DNS, ma dirottare il traffico su nameserver malevoli.
...
- **Effective User ID** (**EUID**): identifica i permessi di un processo (l'Access Control è basato sull'EUID).
